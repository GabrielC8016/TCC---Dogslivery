...
import 'package:dogslivery/Helpers/DeBouncer.dart';
...
class ProductsController {
  ...
  Future<ResponseDefault> addNewProduct(String name, String description,
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse('${URLS.URL_API}/add-new-products'))
  ...
  Future<List<Productsdb>> getProductsTopHome() async {
    ...
    final response = await http.get(
        Uri.parse('${URLS.URL_API}/get-products-top-home'),
  ...
  Future<List<ImageProductdb>> getImagesProducts(String id) async {
    ...
    final response = await http.get(
        Uri.parse('${URLS.URL_API}/get-images-products/' + id),
        headers: {'Accept': 'application/json', 'xx-token': token!});
  ...
  Future<List<Productsdb>> searchPorductsForCategory(String idCategory) async {
    ...
    final resp = await http.get(
        Uri.parse('${URLS.URL_API}/search-product-for-category/' + idCategory),
        headers: {'Accept': 'application/json', 'xx-token': token!});
  ...
  Future<List<Productsdb>> listProductsAdmin() async {
    ...
    final resp = await http.get(
        Uri.parse('${URLS.URL_API}/list-porducts-admin'),
  ...
  Future<ResponseDefault> deleteProduct(String idProduct) async {
    ...
    final resp = await http.delete(
        Uri.parse('${URLS.URL_API}/delete-product/' + idProduct),
        headers: {'Accept': 'application/json', 'xx-token': token!});
