...
class TypePaymentMethod {
  ...
  static List<TypePaymentMethod> listTypePayment = [
    TypePaymentMethod(
        1, 'CARTÃO DE CRÉDITO', FontAwesomeIcons.creditCard, Color(0xff002C8B)),
    TypePaymentMethod(
        2, 'MERCADO PAGO', FontAwesomeIcons.handshake, Colors.lightBlue),
    ...
    TypePaymentMethod(
        5, 'DINHEIRO', FontAwesomeIcons.moneyBill, Colors.green[800]!),
  ];
}
