...
class ListOrdersDeliveryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context)
  {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: TextDogsLivery(text: 'Lista de pedidos'),
        centerTitle: true,
        elevation: 0,
        leadingWidth: 80,
        leading: InkWell(
          ...
          child: Row(
            ...
            children: [
              Icon(Icons.arrow_back_ios_new_rounded, size: 19, color: ColorsDogsLivery.primaryColor ),
      ...
      body: FutureBuilder<List<OrdersResponse>?>(
        future: deliveryController.getOrdersForDelivery('DESPACHOU'),
    ...
    return ( listOrdersDelivery.length != 0 ) 
      ...
      : Column(
        ...
        children: [
          ...
          TextDogsLivery(text: 'Sem pedidos', color: ColorsDogsLivery.primaryColor, fontWeight: FontWeight.w500, fontSize: 21)
        ],
      );
  }
}