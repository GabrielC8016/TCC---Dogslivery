...
class OrderOnWayPage extends StatelessWidget {
  ...
  Widget build(BuildContext context)
  {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: TextDogsLivery(text: 'Encomendas a caminho'),
        centerTitle: true,
        elevation: 0,
        leadingWidth: 80,
        leading: InkWell(
          onTap: () => Navigator.push(context, routeDogsLivery(page: DeliveryHomePage())),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.arrow_back_ios_new_rounded, size: 17, color: ColorsDogsLivery.primaryColor),
      ...
      body: FutureBuilder<List<OrdersResponse>?>(
        future: deliveryController.getOrdersForDelivery('A CAMINHO'),
      ...
      ? ListView.builder(
          ...
          itemBuilder: (_, i) 
            => CardOrdersDelivery(
                ...
                onPressed: () => Navigator.push(context, routeDogsLivery(page: OrdersDetailsDeliveryPage(order: listOrdersDelivery[i]))),
               )
        )
      : Column(
        mainAxisAlignment: MainAxisAlignment.center,
        ...
        children: [
          ...
          TextDogsLivery(text: 'Sem Ordens a caminho', color: ColorsDogsLivery.primaryColor, fontWeight: FontWeight.w500, fontSize: 21)
        ],
      );
  }
}