      ...
      => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            TextDogsLivery(text: 'Selecione a Categoria', fontWeight: FontWeight.w500, fontSize: 19),
                                    ...
                                    Row(
                                      children: [
                                        Container(
                                          ...
                                          width: 20,
                                          decoration: BoxDecoration(
                                            border: Border.all(color: ColorsDogsLivery.primaryColor, width: 3.5),
                                            borderRadius: BorderRadius.circular(6.0)
                                          ),
                                        ),
                                        SizedBox(width: 10.0),
                                        TextDogsLivery(text: category![i].category)
                                      ],
                                    ),
