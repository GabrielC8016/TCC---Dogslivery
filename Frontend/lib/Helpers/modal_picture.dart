      ...
      => Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                TextDogsLivery(text: 'Alterar foto do perfil', fontWeight: FontWeight.w500),
                SizedBox(height: 8.0),
                Container(
                  height: 50,
                  ...
                  child: Card(
                    ...
                    child: InkWell(
                      ...
                      child: Align(
                        ...
                        child: TextDogsLivery(text: 'Selecione uma imagem', fontSize: 17,),
                      ),
                    ),
                  ),
                ),
                Container(
                  ...
                  child: Card(
                    ...
                    child: InkWell(
                      ...
                      child: Align(
                        alignment: Alignment.centerLeft,
                        child: TextDogsLivery(text: 'Tirar uma foto', fontSize: 17,),
                      ),
                    ),
                  ),
                ),
